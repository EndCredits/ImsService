...
.method private getImsDnsServer()Ljava/net/InetAddress;
    ...
    :cond_1
    :goto_0
    const-string v1, "dnsAddress = xx.xx.xx.x"
    ...
    const-string v2, "Modify dnsAddress to StaticDnsServer, dnsAddress = "
...
.method private getStaticDnsServer()Ljava/net/InetAddress;
    ...
    :try_start_0
    const-string v1, "Fallback to static IPV6 = xx.xx.x.x"
    ...
    :try_start_2
    const-string v2, "Can\'t resolve IPV6, Fallback to IPV4 = xx.xx.x.x"
